...
export default function RichTextTemplate({ page }) {
      ...
      <div className="grid gap-8 px-10 py-12 lg:grid-cols-3">
        ...
        {c.sidebar && (
          <div className="space-y-6">
            {(c.sidebar.stats ?? []).length > 0 && (
              <div className="grid grid-cols-2 gap-4">
                {c.sidebar.stats.map((stat, i) => (
                  <div key={i}
                    className="p-5 text-center bg-white shadow-md rounded-xl
