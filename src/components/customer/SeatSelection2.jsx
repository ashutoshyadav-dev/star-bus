...
const SeatIcon = ({ number, type, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`flex flex-col items-center ${type === "booked" ? "cursor-not-allowed" : "cursor-pointer"
        }`}
    >
...
function SeatSelection() {
  ...
  return (
    <div className="w-full text-white bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] px-10 py-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div
                  ...
                  className={`p-4 border rounded cursor-pointer ${paymentMethod === "Card" ? "bg-green-500/30 border-green-400" : "bg-white/10 border-white/20"
                    }`}
                >
                  💳 Card Payment
                </div>
                ...
                <div
                  ...
                  className={`p-4 border rounded cursor-pointer ${paymentMethod === "UPI" ? "bg-green-500/30 border-green-400" : "bg-white/10 border-white/20"
                    }`}
                >
                  📱 UPI
                </div>
                ...
                <div
                  ...
                  className={`p-4 border rounded cursor-pointer ${paymentMethod === "Net Banking" ? "bg-green-500/30 border-green-400" : "bg-white/10 border-white/20"
                    }`}
                >
                  🏦 Net Banking
                </div>
